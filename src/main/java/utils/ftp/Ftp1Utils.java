...
public class Ftp1Utils {
    ...
    public Ftp1Utils(String server, int port, String userName, String userPassword) {
        this.server = server;
        this.port = port;
    ...
    public static void main(String[] args) {
    	Ftp1Utils f = new Ftp1Utils("192.168.162.100", 21, "uftp", "admin");
        try {
            if(f.open()) {
